...
class CellTestReader:
    """
    Cell Test Reader is abstracts importing cell test from an arbitrary tester
    """
    def __init__(self, tester:TESTER, test_type:TEST_TYPE):
        """
        [summary]

        :param tester: [description]
        :type tester: TESTER
        :param test_type: [description]
        :type test_type: TEST_TYPE
        """
        self.tester = tester
    ...
    @staticmethod
    def read_generic(file_path:str, file_type='cvs', mapping='test_time, date_time, voltage, current') -> DataFrame:
        """
        [summary]

        :param file_path: [description]
        :type file_path: str
        :param file_type: [description], defaults to 'cvs'
        :type file_type: str, optional
        :param mapping: [description], defaults to 'test_time, date_time, voltage, current'
    ...
    @staticmethod
    def read_arbin(file_path:str, file_type='xlsx')->DataFrame:
        """
        [summary]

        :param file_path: [description]
        :type file_path: str
        :param file_type: [description], defaults to 'xlsx'
        :type file_type: str, optional
        :return: [description]
        :rtype: DataFrame
        """
    ...
    @staticmethod
    def read_maccor(file_path:str)->DataFrame:
        """
        [summary]
    ...
    @staticmethod
    def read_ornlabuse(file_path:str) -> DataFrame:
        """
        [summary]
    ...
    @staticmethod
    def read_snlabuse(file_path:str)->DataFrame:
        """
        [summary]
    ...
    @staticmethod
    def prepare_maccor_file(cellpath:str)->DataFrame:
        """
        [summary]
...
class ArchiveExporter:
    ...
    @staticmethod
    def write_to_csv(df:DataFrame, cell_id:str, out_path:str, suffix:str) -> str:
        """
        [summary]
    ...
    @staticmethod
    def write_to_feather(df:DataFrame, cell_id:str, out_path:str, suffix:str):
        """
        [summary]
...
def signedCurrent(x:str, y:int)->int:
    if x == "D":
        return -y
    else:
        return y
